        ...
        <CardContent className="space-y-6">
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="rounded-lg overflow-hidden">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SEC.%201_COVER-hXmX1HkXSz1Iwi8FnCGwho80Wjhw2K.png"
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="rounded-lg overflow-hidden">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SEC.%202_SELECTION-u73LG2VnRr8eOQ3anA9doKXNXog4dR.png"
